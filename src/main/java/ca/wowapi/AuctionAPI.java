...
public class AuctionAPI {
	...
	public List<AuctionItem> getAllAuctionInfo(String realm, String region) throws ServerUnavailableException, GuildNotFoundException, InvalidApplicationSignatureException, TooManyRequestsException,
