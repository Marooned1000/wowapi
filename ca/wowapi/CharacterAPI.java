...
public class CharacterAPI {
	...
	public Character getCharacterAllInfo (String name, String realm, String region) throws CharacterNotFoundException, ServerUnavailableException, InvalidApplicationSignatureException
	{
		...
		try {
			...
			else if (jsonobject.getInt("race") == 6|| jsonobject.getInt("race") == 10 || jsonobject.getInt("race") == 9 || jsonobject.getInt("race") == 2 || jsonobject.getInt("race") == 16 || jsonobject.getInt("race") == 8)
			...
			//System.out.println(character.getAchievements().size());
